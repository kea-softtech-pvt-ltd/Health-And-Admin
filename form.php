						...
						<div id="section_1">
							...
							<div class="wrapper_indent">
								...
								<div class="row">
									<div class="col-lg-12">
										<div class="form-group">
											<input type="text" class="form-control" placeholder="Email" value="<?php echo $result['email'];?>" name="email" id="email">
										</div>
								...
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">											
											<input type="radio" name="gender" id="gender" value="1">Male</label>
											<input type="radio" name="gender" id="gender" value="0">Female</label>
										</div>
									</div>
								</div>
								<!-- /row -->
								...
								<div class="row">
									...
									<!--div class="col-md-6">
										<div class="form-group">
											<input type="button" class="btn_1" value="Save And Next" onclick="check();">
										</div>
									</div-->
								</div>	
							</form>
