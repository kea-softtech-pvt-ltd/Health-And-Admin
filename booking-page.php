 ...
 ?>
		...
		<div class="container margin_60">
			<div class="row">
					...
					<div class="step">
						...
						<div class="row">
							<div class="col-md-6 col-sm-6">
								<div class="form-group">
									<label>Email</label>
									<input type="email" id="email" name="email" class="form-control" placeholder="Email Address" value="<?php echo $data['email'];?>">
								</div>
							</div>
							<div class="col-md-6 col-sm-6">
								<div class="form-group">
				...
				<aside class="col-xl-8 col-lg-8" id="sidebar">
					...
					<div class="box_general_3 booking">
						 <form method="post" name="patient_conformation" id="patient_conformation">
							...
							<div>
								<input onclick="patient_appointment();" class="btn_1 " name="submit" type="button" value="Confirm ">
							</div>
						</form>
					</div>
					<!-- /box_general -->
