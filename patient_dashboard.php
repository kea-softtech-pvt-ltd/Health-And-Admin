			  ...
			  <div class="card dashboard text-white bg-primary o-hidden h-100">
				<div class="card-body">
				  <div class="card-body-icon">
					<i class="fa fa-users fa-2x"></i> <span style="font-size:30px;font-weight:bold;"><?php echo $doc['count'];?></span>
				  </div>
				  <div class=""><h3>No of Doctors</h3></div>
				</div>				
			  </div>
			</div>
			<div class="col-xl-4 col-sm-6 mb-3">
		...
		success: function(result){
			...
			var myChart = new Chart(ctx, {
				...
				data: {
					...
					datasets: [
						{
							label: "List Of registered Doctors",
							lineTension: 0.3,
